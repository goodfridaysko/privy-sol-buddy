...
serve(async (req) => {
  ...
  try {
    ...
    const url = `https://lite-api.jup.ag/v6/quote?inputMint=${inputMint}&outputMint=${outputMint}&amount=${amount}&slippageBps=${slippageBps || 50}`;
    console.log('🔗 Calling Jupiter API (lite-api):', url);
